const CONFIG = {
  ...
  commands: [{
    ...
    },
    {
      ...
      name: 'HackerRank',
      key: 'hr',
      url: 'https://www.hackerrank.com/profile/Siddhant_kharwar',
      search: '/results?search_query={}',
      color: 'linear-gradient(135deg, #FFC107, #2196F3, #F44336)',
      icon: 'hackerrank',
      quickLaunch: true,
    ...
    },
    {
      ...
      name: 'InterviewBit',
      key: 'w3',
      url: 'https://www.interviewbit.com/profile/siddhant-kharwar-4-year-b-tech-computer-science-and-engineering/',
      search: '/results?search_query={}',
      color: 'linear-gradient(135deg, #FFC107, #2196F3, #F44336)',
      icon: 'interviewbit',
      quickLaunch: true,
...

    {
      ...
      name: 'LeetCode',
      key: 'lc',
      url: 'https://leetcode.com/u/Pheonix2022/',
      // search: '/results?search_query={}',
...

    {
      ...
      key: 'gfg',
      url: 'https://www.geeksforgeeks.org/user/kharwargpyyq/',
      search: '/search?q={}',
    ...
    },
    {
      ...
      name: 'Coding Ninjas',
      key: 'cn',
      url: 'https://www.naukri.com/code360/profile/siddhantkh',
      search: '/search?q={}',
      color: 'linear-gradient(135deg, #00FF00)',
      icon: 'coding_ninjas',
      quickLaunch: true,
    ...
    },
    {
      ...
      name: 'Monkeytype',
      key: 'mt',
      url: 'https://monkeytype.com/profile/sid1819',
    ...
    },
    {
      ...
      name: 'StackOverflow',
      key: 'st',
      url: 'https://stackoverflow.com/users/27444573/sid1819',
      search: '/search?q={}',
    ...
    },
    {
      ...
      name: 'Notion',
      key: 'ns',
      url: 'https://iitbhucse21sem5.notion.site/iitbhucse21sem5/IIT-BHU-CSE-21-Sem-5-2023-24-8af487233e8a446987ea04b05fa82110',
